...
const ProfilePage = async ({params}: {params: {username: string}}) => {
  ...
  if (!user) return notFound() 
    ...
    if (currentUserId) {
      ...
      res ? isBlocked = true : isBlocked = false
    }
        ...
        <div className="flex flex-col gap-6">
          <div className="flex flex-col items-center justify-center">
            <div className="w-full h-64 relative">
              ...
              <Image src={user.avatar || "/noAvatar.png"} alt="" width={128} height={128} className="size-32 rounded-full absolute left-0 right-0 m-auto -bottom-16 ring-4 ring-white object-cover"/>
            </div>
